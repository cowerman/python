    ...
    def save_image(self, rsp_data, word):
        ...
        for image_info in rsp_data['imgs']:
            ...
            try:
                ...
                print("小图+1,已有" + str(self.__counter) + "小图")
                self.__counter += 1
        return

    # 开始获取
    def get_images(self, word='棉麻'):
        ...
        while pn < self.__amount:
            ...
            url = 'https://image.baidu.com/search/index?tn=baiduimage&ipn=r&ct=201326592&cl=2&lm=-1&st=-1&fm=result&fr=&sf=1&fmq=1520922930125_R&pv=&ic=0&nc=1&z=&se=1&showtab=0&fb=0&width=&height=&face=0&istype=2&ie=utf-8&word=' + search + '&cg=棉麻&pn=' + str(
                pn) + '&rn=60&itg=0&z=0&fr=&width=&height=&lm=-1&ic=0&s=0&st=-1&gsm=1e0000001e'
            # 设置header防ban
            try:
                time.sleep(self.time_sleep)
...
if __name__ == '__main__':
    ...
    crawler.start('棉麻', 10, 1)  # 抓取关键词为 “二次元 美女”，总数为 10 页（即总共 10*60=600 张），起始抓取的页码为 1
